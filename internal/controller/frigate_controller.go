...
// +kubebuilder:rbac:groups=ship.svelama.com,resources=frigates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ship.svelama.com,resources=frigates/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=ship.svelama.com,resources=frigates/finalizers,verbs=update
